...
install.packages((c("data.table","rlist","DiceKriging","mlrMBO", "Rcpp","ranger", "randomForest", "lightgbm")))
library(data.table)
library(Rcpp)
library(ranger)
...
PARAM$final_train  <- c( 202103 ) #, 202104, 202105 --> donde voy a entrenar los Final Models


PARAM$train$training     <- c( 202103 ) #202101, 202102, optimizacion de hiperparametros
PARAM$train$validation   <- c( 202104 )
PARAM$train$testing      <- c( 202105 )
PARAM$train$undersampling  <- 0.10   # 1.0 significa NO undersampling ,  0.1  es quedarse con el 10% de los CONTINUA

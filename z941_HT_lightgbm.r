...
kBO_iteraciones  <- 25  #iteraciones de la Optimizacion Bayesiana (baje de 50)
...
dataset_input  <- paste0( "./exp/", PARAM$exp_input, "/dataset_training6m1.csv.gz" )
